...
const level = require('level');  //esse módulo level é para ser tipo uma banco de dados
const chainDB = './chaindata';   //diretório onde os dados serão gravados

//classe que permite a interação com o banco de dados
class leveldb {
  ...
  // Usado em app.js para alterblocks para mostrar essa cadeia e o trabalho de validação de bloco  - alterar os blocos
