...
// SHA256 com Crypto-js   -  pega esse item na pasta node_modulos
const SHA256 = require('crypto-js/sha256');

// Import do leveldb   -  pega esse item na pasta raíz aqui do projeto 
const Leveldb = require('./blockchainDatabase.js');

// Objeto para persistir a Blockchain  - objeto criado a partir do leveldb, definido na linha anterior
const db = new Leveldb.leveldb;     //leveldb está no arquivo './blockchainDatabase.js'
...
// Classe do Bloco  
// Como cada bloco será criado:
class Block{
  constructor(data){  //essa classe block terá seu construtor
    //abaixo as variáveis do construtor (tudo que irá compor o bloco)
     this.hash = "",
     this.height = 0,
     this.body = data,
     this.time = 0,
...
class Blockchain{
  constructor(){
    ...
    //chama o metodo abaixo 'getBlocksCount' do objeto db, definida no outro arquivo './blockchainDatabase.js' e chamada lá em cima
